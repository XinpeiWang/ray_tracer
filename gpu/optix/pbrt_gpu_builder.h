...
namespace detail {
// Texture/material resolution helpers (namespace detail) - see that file's
// own header comment for why it's split out. Included directly into this
// still-open `namespace pbrt_gpu` block (not a standalone header - never
