...
//
// Mirrors pbrt-v4 CloudMedium (src/pbrt/media.h, Ãƒâ€šÃ‚Â§11.4).
//
...
// an affine transform (3ÃƒÆ’Ã¢â‚¬â€3 matrix + translation) mapping world-space points
// into medium space.
//
...
//                     &sigma_a, &sigma_s)
//   bool sample_ray(ray_o,ray_d,tmax,   -- ray/AABB overlap ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ [tMin,tMax] with
...
// Mirrors pbrt-v4 HomogeneousMajorantIterator (media.h Ãƒâ€šÃ‚Â§11.4) but uses a
...
struct CloudMedium {
	...
	// Affine transform: world ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ medium space.
	// Stored as column-major 3ÃƒÆ’Ã¢â‚¬â€3 matrix + translation.
	// world_to_medium(p) = mat * p + translate
	T mat[9];        // row-major 3ÃƒÆ’Ã¢â‚¬â€3
	T translate[3];
