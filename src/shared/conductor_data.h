...
// ---------------------------------------------------------------------------
// Conductor RGB IOR presets (ÃŽÂ· + iÃ‚Â·k per channel)
//
...
// {wavelength, value} pairs in each array Ã¢â‚¬â€ identical to pbrt-v4's
// PiecewiseLinearSpectrum::operator()(lambda).
//
// Reference: pbrt-v4 Ã‚Â§9.6 "Conductor BRDF", spectrum data in spectrum.cpp
// ---------------------------------------------------------------------------
...
struct ConductorPreset {
	const char* name;
	// Real part of complex IOR (ÃŽÂ·) per RGB channel
...
// ---------------------------------------------------------------------------
// Table Ã¢â‚¬â€ sourced directly from pbrt-v4 spectrum.cpp spectral arrays
// ---------------------------------------------------------------------------

// Gold (Au) Ã¢â‚¬â€ warm yellow reflectance; strongly wavelength-dependent
// ÃŽÂ· drops sharply in the blue/green, k rises through the spectrum
...
// Silver (Ag) Ã¢â‚¬â€ near-achromatic; highest reflectance of any metal
...
// Aluminium (Al) Ã¢â‚¬â€ bright bluish-white; used for brushed metal
...
// Copper (Cu) Ã¢â‚¬â€ warm orange/red tint; k rises into the blue
...
// Iron (Fe) Ã¢â‚¬â€ neutral dark grey; placeholder using typical published values
...
// Lookup by name Ã¢â‚¬â€ returns nullptr if not found
