...
// ---------------------------------------------------------------------------
// Conductor RGB IOR presets (ÃƒÅ½Ã‚Â· + iÃƒâ€šÃ‚Â·k per channel)
//
...
// {wavelength, value} pairs in each array ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â identical to pbrt-v4's
// PiecewiseLinearSpectrum::operator()(lambda).
//
// Reference: pbrt-v4 Ãƒâ€šÃ‚Â§9.6 "Conductor BRDF", spectrum data in spectrum.cpp
// ---------------------------------------------------------------------------
...
struct ConductorPreset {
	const char* name;
	// Real part of complex IOR (ÃƒÅ½Ã‚Â·) per RGB channel
...
// ---------------------------------------------------------------------------
// Table ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sourced directly from pbrt-v4 spectrum.cpp spectral arrays
// ---------------------------------------------------------------------------

// Gold (Au) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â warm yellow reflectance; strongly wavelength-dependent
// ÃƒÅ½Ã‚Â· drops sharply in the blue/green, k rises through the spectrum
...
// Silver (Ag) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â near-achromatic; highest reflectance of any metal
...
// Aluminium (Al) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â bright bluish-white; used for brushed metal
...
// Copper (Cu) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â warm orange/red tint; k rises into the blue
...
// Iron (Fe) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â neutral dark grey; placeholder using typical published values
...
// Lookup by name ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â returns nullptr if not found
