...
//     -- UreÃƒÂ±a et al. 2013 "An Area-Preserving Parametrization for
//        Spherical Rectangles". Samples a point on a quad directly and
//        uniformly in solid-angle measure from a reference point.
//        PDF = 1 / solidAngle  (constant, no distanceÃ‚Â² / cosine conversion).
//
...
CPU_GPU void SampleSphericalTriangle(
	...
	*out_b0 = *out_b1 = *out_b2 = 1.0/3.0;
	...
	// Find barycentric coordinates for direction w via MÃƒÂ¶ller-Trumbore
	V3 p_pt(px, py, pz);
...
// three extra corners (0,1), (1,0), (1,1) Ã¢â‚¬â€ exactly matching pbrt-v4.
//
