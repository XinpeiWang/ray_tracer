...
//
// Two render-loop drivers in bdpt_adapter_entrypoints.h (included at this
// file's own end - split out there along with RandomWalk/AO/SimplePath/
// SimpleVolPath/LightPath's own drivers), mirroring sppm_adapter.h's
...
// Render-loop drivers (BDPT/MLT/RandomWalk/AO/SimplePath/SimpleVolPath/
// LightPath, all Scene=BDPTSceneAdapter above) - split out to
// bdpt_adapter_entrypoints.h, included here so every existing
// #include "bdpt_adapter.h" keeps working unchanged.
#include "bdpt_adapter_entrypoints.h"
