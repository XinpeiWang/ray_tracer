...
(すでにレンダリング中の場合はキューに追加されます)</translation>
    ...
    <message>
        ...
        <location filename="../mainwindow_tabs_render.cpp" line="1234"/>
    ...
    <message>
        ...
        <location filename="../mainwindow_tabs_render.cpp" line="1246"/>
    ...
    <message>
        <location filename="../mainwindow_actions.cpp" line="205"/>
    ...
    <message>
        <location filename="../mainwindow_actions.cpp" line="258"/>
        <source>Save Log</source>
        <translation>ログを保存</translation>
    </message>
    <message>
        <location filename="../mainwindow_actions.cpp" line="260"/>
        <location filename="../mainwindow_actions.cpp" line="303"/>
        <source>Text Files (*.txt);;All Files (*.*)</source>
        <translation>テキストファイル (*.txt);;すべてのファイル (*.*)</translation>
    </message>
    <message>
        <location filename="../mainwindow_actions.cpp" line="267"/>
        <source>[ERROR] Could not write log to %1: %2</source>
        <translation>[ERROR] ログを%1に書き込めませんでした: %2</translation>
    </message>
    <message>
        <location filename="../mainwindow_actions.cpp" line="274"/>
    ...
    <message>
        <location filename="../mainwindow_actions.cpp" line="323"/>
        <source>About Ray Tracer</source>
        <translation>Ray Tracerについて</translation>
    </message>
    <message>
        <location filename="../mainwindow_actions.cpp" line="324"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="466"/>
        <source> · SPPM</source>
        <translation> · SPPM</translation>
    </message>
    <message>
        <location filename="../mainwindow_slots.cpp" line="467"/>
        <source> · BDPT</source>
        <translation> · BDPT</translation>
    </message>
    <message>
        <location filename="../mainwindow_slots.cpp" line="468"/>
        <source> · MLT</source>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="503"/>
        <source>Render Queue (%1)</source>
        <translation>レンダリングキュー (%1)</translation>
    </message>
    <message>
        <location filename="../mainwindow_slots.cpp" line="521"/>
    ...
    <message numerus="yes">
        <location filename="../mainwindow_slots.cpp" line="522"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="575"/>
...
%1</translation>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="962"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1067"/>
        <source>No scenes in this category.</source>
        <translation>このカテゴリにはシーンがありません。</translation>
    </message>
    <message>
        <location filename="../mainwindow_slots.cpp" line="1068"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1264"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1268"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="977"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1299"/>
    ...
    <message>
        ...
        <location filename="../mainwindow_slots.cpp" line="1911"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1718"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1742"/>
        <source>Single Image</source>
        <translation>単一画像</translation>
    </message>
    <message>
        <location filename="../mainwindow_slots.cpp" line="1745"/>
        <location filename="../mainwindow_tabs_render.cpp" line="1379"/>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1902"/>
...
ffmpegのエラーについてはレンダリングログを確認してください。</translation>
    ...
    <message>
        <location filename="../mainwindow_slots.cpp" line="1912"/>
...
This app ships with dozens of built-in scenes covering the basics (a simple Cornell box) up through complex conductor/dielectric materials, volumetric fog, and real photogrammetry-scale models - pick one to render, or browse by category using the tabs above.</source>
        <translation>すべてのレンダリングはシーンから始まります。シーンとは、世界の中身 - ジオメトリ (形状やメッシュ)、マテリアル (表面の材質)、ライト、カメラ - を記述したものです。
...
本アプリには、基本的なもの (シンプルなコーネルボックス) から、複雑なconductor/dielectricマテリアル、ボリュメトリックフォグ、実写フォトグラメトリ規模のモデルまでを網羅する、数十種類の組み込みシーンが同梱されています。レンダリングするシーンを選ぶか、上のタブでカテゴリ別に閲覧してください。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="422"/>
        <source>Generate Thumbnails</source>
        <translation>サムネイルを生成</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="424"/>
...
scene not already cached. CPU-only, low resolution - takes a while the first time.</source>
        <translation>キャッシュがまだない自己完結型のBasics/Materials/Textures/Camerasシーンについて、
小さなプレビュー画像をそれぞれレンダリングします。CPUのみ・低解像度で行われるため、初回は時間がかかります。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="520"/>
        <source>Rendering Technique:</source>
        <translation>レンダリング技法:</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="521"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="547"/>
        <source>Apply</source>
    ...
    <message>
        ...
        <translation>サンプラー/インテグレータ/光源サンプラー(レンダリングオプションタブ)を、このシーン自身の推奨値に設定します。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="566"/>
...
「動画を生成」はカメラパスをフレームごとにレンダリングし、MP4として合成します。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="660"/>
...
including the handful the GPU backend does not implement.</source>
        <translation>GPU: OptiXによるハードウェアレイトレーシング — 通常は桁違いに高速です。
CPU: 重点的サンプリングによるパストレーサー — GPUバックエンドが
未実装のごく一部のものも含め、すべてのシーンとマテリアルに対応します。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="680"/>
...
GPU (OptiX) uses NVIDIA&apos;s dedicated ray-tracing cores to trace thousands of rays in parallel, typically far faster. CPU uses ordinary processor cores instead: much slower, but works on any machine and supports every material this app implements, including a couple the GPU path hasn&apos;t caught up to yet.</source>
        <translation>どちらもまったく同じ光線を追跡し、同じ画像を生成します - 違うのは物理計算ではなく、速度とハードウェアです。
...
Only applies when Renderer is set to GPU.</source>
        <translation>Recursive: 1ピクセルにつき1スレッドを使う、既定のGPUパストレーサーです — 対応範囲が広く、実績も豊富です。
...
Recursive traces one ray per thread from start to finish, bouncing recursively - simple and battle-tested. Wavefront instead groups all rays currently doing the same kind of work (e.g. &quot;just hit glass&quot;) into a batch and processes them together - better use of the GPU&apos;s parallel hardware on complex scenes with lots of different materials, at the cost of being a newer, less-tested code path.</source>
        <translation>GPU上で同じレイトレーシング処理を行うための、2つの異なる方式です。
...
Recursiveは1スレッドにつき1本の光線を最初から最後まで再帰的にバウンスさせながら追跡します - シンプルで実績のある方式です。一方Wavefrontは、現在同じ種類の処理を行っている光線 (例えば「ガラスにちょうど当たった」光線) をまとめてバッチ化し、一括で処理します - 多様なマテリアルを含む複雑なシーンでGPUの並列ハードウェアをより有効活用できますが、その分新しく、実績の少ないコードパスです。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="97"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="130"/>
...
上部のサンプラー/スペクトル/露出/トーンマッピング/統計情報は、デフォルトのパストレーサーにのみ影響します - 詳細は各コントロール自体のツールチップを参照してください。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="165"/>
...
Hover any item in the dropdown for details on that specific integrator.</source>
        <translation>レンダリング速度だけでなく、レンダリングアルゴリズムそのものを選びます。パストレーサー(デフォルト)は、このアプリの他の部分でも使われている汎用的で十分に検証された選択肢です。
...
ドロップダウン内の各項目にカーソルを合わせると、そのインテグレータの詳細を確認できます。</translation>
    ...
    <message>
        ...
        <location filename="../mainwindow_tabs_render.cpp" line="182"/>
...
1段階上げるごとにレンダリング時間はおよそ2倍になりますが、その分ノイズの少ないきれいな画像が得られます - Draftはシーンの見た目をすばやく確認するため、Ultra/Maximumはじっくり眺めたい最終画像のためのプリセットです。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="782"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="785"/>
        <source>600 x 600</source>
        <translation>600 x 600</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="786"/>
        <source>800 x 800</source>
        <translation>800 x 800</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="787"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="789"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="791"/>
...
Tips: use GPU mode for faster rendering. Lower samples/pixel (10-50) for quick previews, higher (100-500) for production quality. Typical render time is 1-5 minutes on GPU, 15-60 minutes on CPU.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1160"/>
        <source>SVGF Denoiser (experimental)</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1201"/>
        <source>Cleans up Live Preview&apos;s noisy low-sample image using the same OptiX AI denoiser the Render Options tab&apos;s own Denoiser checkbox runs for finished renders - lets the view look reasonable almost immediately instead of waiting many frames to converge. Costs a small amount of GPU time per frame. The number to its right blends between the noisy original and the fully denoised result, same as the Render Options tab&apos;s own blend control.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Blend between the noisy input and the fully denoised output (0.0 = 100% denoised, 1.0 = original noisy image), same meaning as the Render Options tab&apos;s own blend control.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1216"/>
        <source>Displays each denoised frame as-is instead of averaging it into a running mean with earlier frames. Trades away the extra quality accumulating more samples would eventually reach, in exchange for a view that always reflects only the most recent frame - useful while flying around with WASD, where older accumulated frames are from a camera position you&apos;ve already left.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1223"/>
        <source>Cleans up Live Preview using SVGF (Spatiotemporal Variance-Guided Filtering) instead of the OptiX AI denoiser - tracks per-pixel variance over time and uses it to drive an edge-aware spatial filter, which holds up better during camera movement than the AI denoiser + running-mean combination above. Always shows the latest filtered frame rather than accumulating (there is no separate &apos;show latest&apos; option for it, and no blend control - its output is always fully filtered). Mutually exclusive with the OptiX AI denoiser above.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1275"/>
        <source>Temporal Alpha:</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1276"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1280"/>
        <source>Max History Length:</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1281"/>
        <source>Caps how many frames of history a converged pixel can accumulate - bounds how &quot;sticky&quot; it gets.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1284"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1295"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1300"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1304"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1435"/>
...
Paired with Height to set the resolution manually, overriding whatever the Quality preset above would otherwise use.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1528"/>
...
Paired with Width - together they set the resolution manually, overriding the Quality preset above.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1761"/>
        <location filename="../mainwindow_tabs_render.cpp" line="807"/>
        <source>Output</source>
        <translation>出力</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1764"/>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1787"/>
...
生の.ppmファイルは常に書き出され、あわせて.pngのコピーが自動生成されます - ほとんどの画像ビューアー（および本アプリ自身のプレビュー）は.ppmを直接開けないため、プレビュータブには常に.pngが表示されます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1831"/>
...
the render time. Setting it here switches Quality to Custom.</source>
        <translation>1ピクセルあたりに追跡する光線の本数です。これは品質と時間を左右する主要なダイヤルで、
...
サンプル数が多いほど平均値の精度が上がり、画像の粒状の「ノイズ」が減ります。ただし、サンプルを増やすほどレンダリング時間もかかります。この値を2倍にするとノイズはおよそ半分になりますが、レンダリング時間もおよそ2倍になります。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1560"/>
...
バウンス回数を1つ増やすごとに、光がもう1面分だけ余分に伝わってから打ち切られるようになります。これがガラスや鏡、柔らかい間接照明を正しく見せる仕組みです。ほとんどのシーンは最大値よりかなり低い深度で「完成」して見えます。それ以上深度を増やしても、ほとんどの場合ほぼ影響しないほど暗い光を追跡するだけです。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1596"/>
        <source>Camera Position</source>
        <translation>カメラ位置</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1640"/>
        <source>Front View (Outside)</source>
        <translation>正面ビュー(外側)</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1643"/>
        <source>Inside Front</source>
        <translation>内側前方</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1644"/>
        <source>Inside Back</source>
        <translation>内側後方</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1645"/>
        <source>Right Wall (Green)</source>
        <translation>右壁(緑)</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1646"/>
        <source>Left Wall (Red)</source>
        <translation>左壁(赤)</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1649"/>
...
「カスタム」を選択すると下のX/Y/Zフィールドが有効になり、カメラを自由な位置に配置できます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1679"/>
...
上のプリセットが「カスタム」に設定されている場合のみ編集できます。カメラは常にシーン固有の固定注視点を向き続けるため、X/Y/Zを動かすと単純な左右のパンではなく、視野角と距離の両方が変化します。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1695"/>
...
カメラXと同じく、「カスタム」プリセットの時のみ編集可能です。動かしている間もカメラはシーンの固定注視点を向き続けます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1708"/>
...
カメラX/Yと同じく、「カスタム」プリセットの時のみ編集可能です。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs.cpp" line="1740"/>
...
X/Y/Zフィールドやプリセットで気に入ったアングルを見つけたあと、手早くズームイン・ズームアウトするのに最適です。</translation>
    ...
    <message>
        ...
        <source>⚠ Live Preview uses the GPU progressive path tracer directly - none of the settings on this tab apply to it.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="209"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="224"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="249"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="274"/>
        <source>Mutations:</source>
        <translation>変異回数:</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="275"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="284"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="300"/>
        <source>Max occlusion distance:</source>
        <translation>最大オクルージョン距離:</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="301"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="308"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="316"/>
        <source>Illumination scale:</source>
        <translation>照明スケール:</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="317"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="334"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="354"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="387"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="395"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="405"/>
...
or under BDPT/MLT/SPPM/the debug integrators.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="514"/>
...
becomes a ceiling, not a fixed count. CPU default path tracer only.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="540"/>
...
Lower = cleaner but slower. 0.01 matches Blender Cycles&apos; own default.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="551"/>
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Settings tab to use it.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="566"/>
...
tracer only.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="577"/>
        <source> s</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
...
budget above.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="591"/>
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Settings tab to use it.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="864"/>
...
グレーアウトしていますか? これはCPUレンダラーのデフォルトパストレーサーにのみ影響します - 使用するには、基本設定タブでレンダラーをCPUに切り替えてください。</translation>
    ...
    <message>
        ...
        <translation>シーン内の光源に対して空間階層構造を構築し、単一のグローバルな重み付けを使う代わりに、各光源をパワーとシェーディング点への近さの両方で重み付けして、バウンスごとに適応させます。pbrt-v4自体のデフォルトです - わずかな追加の管理コストと引き換えに、一般的に最も収束が優れています。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>光源が放つ全パワー(総放射束)に応じた確率で光源を選びます - 明るい光源ほど頻繁にサンプリングされます。光源の明るさに大きな差があるシーンでは一様よりも速く収束しますが、距離や遮蔽は考慮されません。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>シーン内のすべての光源から、明るさや距離に関係なく一様なランダムで光源を選びます。単純で不偏ですが、明るさが大きく異なる光源が多いシーンでは収束が遅くなります - 暗い光源も明るい光源と同じ頻度でサンプリングされてしまいます。</translation>
    </message>
    <message>
...
グレーアウトしていますか? これはCPUレンダラーのデフォルトパストレーサーにのみ影響します - 使用するには、基本設定タブでレンダラーをCPUに切り替えてください。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="627"/>
...
Off by default, matching pbrt-v4&apos;s own default. If a loaded .pbrt scene&apos;s file already requests this itself, it&apos;s applied either way - this checkbox can only add the request on top, never take it away.</source>
        <translation>光路の中には、パストレーサーがきれいに見つけるのが本質的に難しいものがあります - 粗い(しかし完全な鏡面ではない)面で跳ね返り、別の粗い面を通過して、小さく明るい光源に至るような光です。そうした経路は、平均化して消えるまでに非常に長い時間がかかる、明るく孤立した斑点(&quot;ファイアフライ&quot;)として現れます。
...
既定では無効で、pbrt-v4自身のデフォルトと一致しています。読み込んだ.pbrtシーンのファイルがすでにこれ自体を要求している場合、どちらにしても適用されます - このチェックボックスは要求を上乗せするだけで、取り除くことはありません。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="650"/>
...
per-sample-total.</source>
        <translation>最も明るいチャンネルが下の値を超えるピクセルサンプルを
...
wavefrontはサンプル合計単位ではなく寄与単位で近似します。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="681"/>
...
Off by default (effectively unbounded, matching pbrt-v4&apos;s own default). CPU default path tracer only.</source>
        <translation>モンテカルロパストレーサーは、個々には正しいものの極端に明るいパス - ちょうど良い角度で小さく強い光源をかすめたレイ - を時折サンプリングしてしまい、そのような1つのサンプルが、他の十分な数のサンプルが到着して均されるまでの間、長時間にわたってピクセルの平均値を支配してしまうことがあります。これらは明るく孤立した斑点(&quot;ファイアフライ&quot;)として現れます。
...
既定では無効です(pbrt-v4自身のデフォルトと同じく、実質的に無制限)。CPUのデフォルトパストレーサーのみに適用されます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="853"/>
...
CPU版のデフォルトパストレーサーのみで有効です。GPU、またはBDPT/MLT/SPPM/デバッグ用インテグレーターでは効果がありません。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="425"/>
...
default Path Tracer - see each control&apos;s own tooltip.</source>
        <translation>使用するレンダリングアルゴリズムを選択します。パストレーサー(デフォルト)は十分に検証された汎用の選択肢です - 下の代替インテグレータは、その汎用性の代わりに特定の技術(フォトンマッピング、双方向/Metropolis光輸送、あるいはいくつかの不偏な参照用・デバッグ用インテグレータ)を選びます。SPPMを除くすべての代替インテグレータはCPU専用であり、いずれも動画生成モードと組み合わせることはできません。

下のサンプラー/スペクトル/露出/トーンマッピング/統計情報は、デフォルトのパストレーサーにのみ影響します - 詳細は各コントロール自体のツールチップを参照してください。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="426"/>
        <source>Ray tracing needs a lot of random numbers - which direction to bounce a ray, which point on a light to sample, and so on - and HOW those &quot;random&quot; numbers are generated changes how quickly the image converges to a clean result.
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Settings tab to use it.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="484"/>
        <source>Every diffuse/glossy bounce needs to pick ONE light (out of potentially many) to sample directly for next-event estimation - which light gets picked, and how fairly, changes how quickly the image converges, though never what it converges TO.
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Settings tab to use it.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="505"/>
...
than silently rendering wrong colors. Noticeably slower per-sample.</source>
        <translation>単純なRGBの代わりに、実際のhero-wavelength方式によるスペクトルレンダリングを行います。
...
CPU・GPUいずれのデフォルトパストレーサーでのみ有効です。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="617"/>
...
1.0では画像は変化せず、1.0未満で暗く、1.0を超えると明るくなります。シーン自体の照明を変更せずに、正しくレンダリングされているものの単に明るすぎる・暗すぎて見づらいシーンを調整するのに便利です。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="705"/>
        <source>Accelerator</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="708"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="719"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="736"/>
...
scene (has no Accelerator directive to override - see the log).</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="742"/>
        <source>Accelerator:</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
...
Only a loaded .pbrt scene has an Accelerator directive to override at all - a native (non-.pbrt) scene always uses its own fixed BVH regardless of this choice (a warning is printed if you pick something else anyway).</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="762"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="767"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="776"/>
        <source>HLBVH</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
...
warning is printed when that happens.</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="790"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="810"/>
        <source>Tone mapping curve, whether to print render statistics, GPU denoising, and OptiX validation mode - behavior flags for how the final image is processed and reported, not what to render.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="820"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="823"/>
...
effect under BDPT/MLT/SPPM/the debug integrators.</source>
        <translation>sRGBカーブを適用する前に、どのトーンマッピング演算子を使用するかを選択します。
CPU・GPU(再帰型・wavefront型の両方)に適用されます。BDPT/MLT/SPPM/デバッグ用インテグレーターでは効果がありません。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="828"/>
...
ACES rolls off bright highlights gently, the way film does; Reinhard is a simpler, older compression; None just clips anything too bright to flat white, which can look harsh.</source>
        <translation>レイトレースされたシーンの真の明るさの値には上限がなく、たとえば電球は壁の100倍も明るいことがあります。しかし画面が表示できる明るさの範囲は限られています。トーンマッピングとは、この広大な明るさの範囲を表示可能な範囲へ圧縮するカーブのことです。

ACESはフィルムのようになだらかにハイライトを丸めます。Reinhardはより単純で古い方式の圧縮です。「なし」は明るすぎる部分を単純に真っ白にクリップするため、きつい印象になることがあります。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="838"/>
...
Purely informational: it never changes the rendered image, just tells you what the renderer actually did.</source>
        <translation>レンダリング終了後に、発射されたレイの数、発生したバウンスの数、追跡されたシャドウレイの数、秒間サンプル数といった短い要約を出力します。
...
グレーアウトしている場合は、GPU再帰型バックエンドが必要です。ベーシック設定タブでレンダラーをGPUに(GPUバックエンドをRecursiveに)切り替えると使用できます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="894"/>
        <source>OptiX validation mode (slower, debugging only)</source>
        <translation>OptiX検証モード(低速・デバッグ専用)</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="896"/>
...
グレーアウトしている場合はGPU専用の設定です。ベーシック設定タブでレンダラーをGPUに切り替えると使用できます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="916"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="929"/>
...
path tracer only.</source>
        <translation>レンダリングを、フレーム内の矩形領域に制限します。矩形は
画像全体に対する[0,1]の割合で指定します。CPUとGPUの
デフォルトパストレーサーのみに適用されます。</translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="934"/>
...
Off by default (the full frame). If a loaded .pbrt scene&apos;s file already requests its own cropwindow/pixelbounds, checking this overrides it with the rectangle below; leaving it unchecked lets the scene&apos;s own request (if any) stand.</source>
        <translation>画像全体ではなく、フレームの矩形の一部分だけをレンダリングします - それ以外の領域は黒のままになります。矩形は、フレーム全体の幅/高さに対する4つの割合として、0(左端/上端)から1(右端/下端)の範囲で指定するため、解像度に関わらず同じ形状を保ちます。
...
既定では無効です(フレーム全体)。読み込んだ.pbrtシーンのファイルがすでに独自のcropwindow/pixelboundsを要求している場合、これを有効にすると下の矩形で上書きされます。無効のままにしておくと、シーン自身の要求(もしあれば)がそのまま有効になります。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="976"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="982"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1002"/>
...
再現できるようにします。CPUとGPUのデフォルトパストレーサーのみに適用されます。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1008"/>
...
既定では無効です(毎回本当にランダムなレンダリングになります)。</translation>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1024"/>
        <source>Seed:</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1237"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1275"/>
...
Drag to orbit, scroll or +/- to zoom, WASD to move, Up/Down to fly</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1375"/>
        <source>Live Preview — %1</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1380"/>
        <source>Interactive GPU preview - drag to orbit, scroll or +/- to zoom, WASD to move, Up/Down to fly, Left/Right to orbit</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1406"/>
        <source>Select a scene first</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1455"/>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1490"/>
        <source>%1 samples</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="1506"/>
        <source>Live Preview: %1</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="2068"/>
        <location filename="../mainwindow_tabs_render.cpp" line="2081"/>
        <source>Pause</source>
    ...
    <message>
        <location filename="../mainwindow_tabs_render.cpp" line="2091"/>
...
速度0.5xでは、同じ経路をよりゆっくり滑らかにたどるため、レンダリングするフレーム数が2倍になります。速度2xでは、同じ経路をより速くたどるため、フレーム数は半分になります。</translation>
    ...
    <message>
        <location filename="../mainwindow_style.cpp" line="1128"/>
...
The alternates below trade that generality for a specific technique - photon mapping, bidirectional/Metropolis light transport, or a handful of unbiased reference and debug integrators. All are CPU-only except SPPM, and none can be combined with Generate Video mode. Sampler/Spectral/Exposure/Tonemap/Stats above only affect this default Path Tracer.</source>
        <translation>このアプリの他の場所でも使われている汎用の重要度サンプリング付きパストレーサーです - Next Event EstimationとBSDF重要度サンプリングを、パワーヒューリスティック(MIS)で組み合わせています。十分に検証されたデフォルトです。特別な理由がない限り、まずはここから始めてください。
...
GPU: capability-checked per scene - Lambertian/DiffuseLight, RoughDielectric, Metal, Dielectric, Conductor, RoughMetal, and DiffuseTransmission are supported (area lights only); an unsupported scene falls back to an error - use CPU SPPM instead.</source>
        <translation>Stochastic Progressive Photon Mapping(pbrt-v4スタイル)です。通常のパストレーシングでは解決が難しい強いコースティクス/ガラスのシーンに最適です。
...
CPU only. Area lights only (no punctual/sky-light NEE yet). Verified end-to-end on the Cornell Box scene only; other scenes are unverified.</source>
        <translation>双方向パストレーシング - カメラと光源の両方からサブパスを追跡し、すべてのペアを接続します。通常のパストレーシングだけでは苦手とする、一部の難しい照明構成でより有効です。

CPU専用です。面光源のみ対応(点光源/スカイライトのNEEは未対応)。Cornell Boxシーンでのみエンドツーエンドの検証済みで、それ以外のシーンは未検証です。</translation>
    </message>
    <message>
        <location filename="../mainwindow_style.cpp" line="1163"/>
...
CPU only. Same area-lights-only scope and single-scene (Cornell Box) verification as BDPT.</source>
        <translation>BDPTのサブパス機構の上に直接構築されたMetropolis Light Transportです - マルコフ連鎖を使って、すでに寄与している光路にサンプルを集中させます。見つけにくい明るい光路を持つシーンに有効です。
...
CPU only.</source>
        <translation>pbrt-v4の不偏な参照用パストレーサーです - 一様球面サンプリングを使用し、Next Event Estimationも多重重要度サンプリングも使用しません。デフォルトのパストレーサーよりシンプルでノイズが多く、他のインテグレータを検証するための正解基準として有用です。

CPU専用です。</translation>
    </message>
    <message>
        <location filename="../mainwindow_style.cpp" line="1179"/>
...
CPU only.</source>
        <translation>実際に照明されたレンダリングではなく、可視化・デバッグ用のモードです - マテリアルの色や間接光を完全に無視して、各点が近くのジオメトリによってどれだけ遮蔽されているかを測定します。

CPU専用です。</translation>
    </message>
    <message>
        <location filename="../mainwindow_style.cpp" line="1185"/>
...
CPU only. NEE, when enabled, is area-lights-only, the same scope as BDPT/MLT.</source>
        <translation>pbrt-v4の標準的な参照用パストレーサーです - Next Event Estimationのオン/オフとBSDF重要度サンプリングのオン/オフを選択でき、いずれもデフォルトで有効です(下のトグルを参照)。
...
CPU only.</source>
        <translation>pbrt-v4の最もシンプルなボリュームパストレーサーです - 純粋なデルタトラッキングのみで、NEE/MIS/表面BSDFは使用しません。
...
CPU専用です。</translation>
    ...
    <message>
        <location filename="../mainwindow_style.cpp" line="1201"/>
...
CPU only. Area lights only.</source>
        <translation>純粋なライトトレーサーです - ここにある他のすべてのインテグレータとは逆方向に動作します。各サンプルはカメラではなく光源から出発し、カメラとの接続による寄与をフィルムにスプラットします。

CPU専用です。面光源のみ対応。</translation>
    </message>
    <message>
        <location filename="../mainwindow_style.cpp" line="1220"/>
    ...
    <message>
        <location filename="../mainwindow_style.cpp" line="1224"/>
        <source>OptiX validation: on</source>
        <translation>OptiX検証: オン</translation>
    </message>
    <message>
        <location filename="../mainwindow_style.cpp" line="1225"/>
    ...
    <message>
        <location filename="../mainwindow_style.cpp" line="1264"/>
    ...
    <message>
        <location filename="../mainwindow_style.cpp" line="1310"/>
...
<context>
    ...
    <message>
        ...
        <translation>共有のコーネルボックスデータからボックスを構築します。5枚のlambertian壁、diffuse_lightの天井クアッド、白いlambertianの回転軸並行ボックス、そして完全なFresnel加重の反射/屈折を行うdielectric BSDFの球体で構成されます。このレンダラーの基準となる収束テストであり、壁面同士の拡散相互反射、BSDFサンプリングの正しさを確認する鏡面/透過オブジェクト、そしてNext Event Estimation(NEE)を働かせるエリアライトクアッドを備えているため、マテリアルやライトサンプリングに関わる横断的な不具合の多くがまずここで最初に現れます。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>地面と大きな球体はどちらも、ワールド空間座標から直接評価されるPerlinノイズ/タービュランスベースのプロシージャルな大理石テクスチャを使用し、lambertianに供給されます。画像テクスチャは一切使用していません。対比のために、より高いノイズ周波数で同じ手法を再利用した2つの小さな随伴球体があり、Next Event Estimation(NEE)でサンプリングされるdiffuse_lightクアッドによって照らされます。Perlinノイズによるタービュランス/大理石の出力が、単純な環境光ではなく実際のNEE照明のもとでBSDFパイプラインに正しく供給されるかをテストします。</translation>
    </message>
    <message>
        ...
        <translation>それぞれ異なる基底ベクトルによって異なる向き(正面向き、側面向き、上面向き)を持つ5枚のクアッドプリミティブがあり、それぞれ単色のlambertianを持ちます。これは複雑なシェーディングではなく、クアッドの平面交差判定と向きごとの法線/UV計算をテストするものです。部屋の中には独立したdiffuse_lightクアッドが浮かんでおり、シーン唯一の発光体としてNext Event Estimation(NEE)の重点サンプリング対象になります。主に、実際のエリアライトサンプリングのもとでのクアッド形状と向き依存の法線の正しさを確認するテストです。</translation>
    </message>
    <message>
        ...
        <translation>大理石テクスチャシーンで使われたPerlinノイズの地面/球体構成を再利用していますが、本当の主題は発光です。diffuse_lightマテリアル(暖色)を与えられた球体が、曲面で非平面のエリアライト発光体として機能し、それとは別に寒色のdiffuse_lightクアッドも配置されています。球体とクアッドという2種類の発光体が同じシーンに存在することで、ライトサンプリングが通常の平坦なクアッドの場合だけでなく、異なる発光体形状にわたって立体角サンプリングを正しく扱えるかをテストします。色温度を分けることで、どちらの光がどこに寄与しているかが一目でわかるようになっています。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>同じ金色のrough_metalマテリアル(GGX/Trowbridge-Reitzマイクロファセット分布に、複素IORによる完全なFresnelではなく単純なRGB色付き反射率を組み合わせたもの)で、粗さ(roughness)の値だけを変化させた5つの球体が一列に並んでいます。1つのエリアライトの下、地面プレーン上に単独で置かれているため、フレーム内で変化する唯一の要素は、粗さが増すにつれて鏡面ハイライトがどう広がり弱まっていくかだけです。</translation>
    </message>
    <message>
        ...
        <translation>rough-metal-spheresシーンと同じrough_metalのGGX BxDF(異なる粗さのブラッシュドアルミニウムのボックスとブラッシュドゴールドの球体)を使用していますが、開放的なスタジオ設定ではなく、おなじみのコーネルボックスの中に配置されています。そのため、光沢のあるマイクロファセット反射は、単一のオーバーヘッドライトではなく、実際の間接バウンス照明や色付きの壁からの色滲みのもとで整合性を保つ必要があります。</translation>
    </message>
    <message>
        ...
        <translation>コーネルボックスのガラス球体を、完全なdielectricからrough_dielectricに置き換えたシーンです。GGXマイクロファセットが反射ローブと透過ローブの両方に適用されるため、屈折光は鋭いスネルの法則によるレイではなく、すりガラスのようにぼやけて散乱します。それでも各マイクロファセットではFresnelによる反射/透過の分配が正しく守られています。</translation>
    </message>
    <message>
        ...
        <translation>研磨された金とアルミニウムの表面に、conductorマテリアルを使用しています。RGBアルベドによる近似ではなく、実測されたeta/kスペクトルに基づくチャンネルごとの実際の複素Fresnelを使用しているため、メタルの色はアーティストが選んだ色味ではなく、実際の反射率スペクトルから生じています。</translation>
    </message>
    <message>
        ...
        <translation>coated_diffuseを使用した、コート層付き拡散反射の球体とボックスです。Lambertianのベース層の上に粗いdielectricコートが重ねられています。これは層状BSDFの解法をテストするもので、光はコート表面で鏡面反射することも、コートを透過してベースの拡散色を拾うこともでき、2つの層の間では内部反射も起こります。</translation>
    </message>
    <message>
        ...
        <translation>thin_dielectricを使用した垂直なガラス板が、コーネルボックスを2つに分割しています。これは厚みゼロのガラスで、実際の屈折面の代わりに解析的な多重反射Fresnel計算式を用いるため、透過するレイは屈曲せずまっすぐ通過します。IOR 1.5のFresnel反射率はほぼ視線に対して斜め(グレージング角)に近い角度でしか目立たないため、この板は意図的に傾けて配置されています。</translation>
    </message>
    <message>
        ...
        <translation>coated_conductorによる漆塗りメタルの質感です。金の球体と銅のボックスはそれぞれ、チャンネルごとの複素Fresnelを持つGGX conductorベースの上に粗いdielectricコートを重ねています。このカテゴリの中で最も層が重なったBxDFであり、無彩色の光沢コートの下にスペクトルによるメタル反射率を組み合わせることで、メタル自体の色味の上にコートのFresnelによる艶が乗る様子を示しています。</translation>
    </message>
    <message>
        ...
        <translation>diffuse_transmissionを使用した、蝋のような質感の球体で、反射色と透過色が別々に指定されています。光は同じ半球(反射)と反対側の半球(透過)の両方に拡散的に散乱します。これは、subsurfaceスラブのシーンが同じ見た目のゴールに対してボリュームによるランダムウォークを必要とするのに対し、それを必要としない、半透明性の安価な2パラメータの代替表現です。</translation>
    </message>
    <message>
        ...
        <translation>normalized_fresnelを使用した水晶のような球体です。これはFresnel加重の拡散射出であり、視線に対して斜めの角度(グレージング角、Fresnel透過率が低いため内部で散乱した光がより多く抜け出す方向)に近づくほどBSDFの値が上昇します。サンプリング自体は余弦半球サンプリングのままですが、散乱PDF自体がFresnel加重を担っており、MIS(多重重点サンプリング)のもとで反射エネルギーの総量が正しく保たれるよう正規化されています。</translation>
    </message>
    <message>
        ...
        <translation>principledマテリアルのパラメータ空間を一列で網羅する7つの球体です。マットな拡散反射、低粗さのプラスチック、クリアコート付きプラスチック、半メタリック、粗さのある準メタリック、滑らかな完全メタル、クリアコート付き完全メタルという構成で、metallic・roughness・clearcoatをそれぞれ独立に変化させ、このカテゴリの他のシーンで個別のマテリアルとして扱われているdielectricからconductorまでの全範囲を、1つの統一されたBSDFがどうカバーするかを示しています。</translation>
    </message>
    <message>
        ...
        <translation>hairマテリアル(HairBxDF)を、それぞれ異なる吸収率/粗さのパラメータで使用した5つの球体です。拡散的というより、強く前方/鏡面方向に散乱するファイバーBSDF向けに調整されています。hairのBSDFのピーク応答は通常のエリアライト強度では白飛びしてしまうため、このセットの他のシーンよりもかなり暗く光量を再調整する必要がありました。実際のカーブ形状ではなく球体の表面に適用することで、BxDFのシェーディング挙動をカーブ交差判定の仕組みから切り離してテストしています(カーブ交差判定の方はCurve Fibersシーンを参照してください)。</translation>
    </message>
    <message>
        ...
        <translation>単純なLambertian面に対する2種類の摂動技法です。バンプマッピングはPerlinノイズによる大理石テクスチャ(背面壁とボックス)からシェーディング法線をずらし、法線マッピングはチェッカーパターン(球体)からシェーディング法線を摂動させます。幾何形状自体は平坦/球形のままですが、照明計算に使われるシェーディング法線が曲げられることで、細かい表面のディテールを疑似的に表現しています。</translation>
    </message>
    <message>
        ...
        <translation>厳密には真のBSSRDFではありません。乳白色の蝋のスラブと翡翠の球体に入った光は、dielectricの殻を通過してconstant_medium(独自の密度と色味を持つ均質な参加媒質)へと入っていきます。そのため、この半透明な輝きは拡散ベースのサブサーフェス項ではなく、表面での屈折Fresnelに境界づけられた物体内部での実際のボリュームによるランダムウォークから生じています。</translation>
    </message>
    <message>
        ...
        <translation>pbrt-v4の実測BRDFデータパイプラインをテストするシーンです。5つの球体の列にわたって、実際に計測されたマテリアルではなく、合成生成されたテーブル化NDF、sigma、VNDF、輝度、波長ごとのスペクトルテーブルを使用しています。BSDFの評価自体は、完全な5次元重点サンプリングのワープ連鎖ではなく、単色の余弦半球サンプリングに簡略化されているため、このシーンは現実的な実測マテリアルの結果というより、テーブル化データの配線経路そのものをテストするものです。</translation>
    </message>
    <message>
        ...
        <translation>文字通りの三角ガラスプリズムで、分散性のあるdielectricを使用しています。これは一定のIOR値の代わりに、実際のクラウンガラスに合わせて波長ごとに変化するコーシーの式による屈折率を持ちます。プリズムに入った白色光は出射時に波長ごとに分かれ、実物のガラスプリズムのように受光スクリーン上で扇状に広がります。ただしこれは、レンダラー内で波長ごとにレイを追跡する--spectralを有効にした場合に限られます。無効の場合は、RGBの各チャンネルがそれぞれわずかに異なる固定量で屈折するだけで、連続的な広がりにはなりません。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>pbrtの「mix」マテリアルは、単純に混合した色を出すのではなく、各シェーディング点においてサンプルごとに実際の確率的選択を行うことで2つのマテリアルをブレンドします。各ヒットで確率に応じた選択が行われるため、マットな拡散反射とメタリックなconductorの混合は、本物の粒状のノイズとして表れます。あるサンプルは純粋な拡散反射、別のサンプルは純粋な鏡面反射となり、多数のサンプルにわたって正しく平均化されます。CPU、GPU再帰型、GPU wavefront型のいずれでも同一の動作をします。</translation>
    </message>
    <message>
        ...
        <translation>このアプリの他のどこにもまとまって登場しない4種類のマテリアルです。thindielectric(通常のdielectricと異なり、レイの位置をずらさずに屈折させる厚みゼロのガラス板)、coatedconductor(メタルベースの上のクリアコート)、diffusetransmission(薄い葉や紙のように、光が反射だけでなく透過もする)、そして名前付きプリセット(「Marble」)によるsubsurface scatteringです。外部の実測データファイルを必要とせずに、本物のサブサーフェスパラメータを実現しています。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのCoatedDiffuseマテリアル(ニス塗りの木材のように、クリアなdielectricコートの下に拡散反射ベースを持つマテリアル)が、単色ではなく実際の画像テクスチャから反射率を読み取っています。以前はこの組み合わせで、両方のバックエンドともテクスチャが警告なく無視され、単色グレーにフォールバックしてしまっていました。</translation>
    </message>
    <message>
        ...
        <translation>名前付きプリセットではなく、明示的なRGBのeta/k(金属特有の色味を持つ波長依存の反射率を生み出す複素屈折率)によって駆動されるconductorマテリアルです。加えて、同じ複素IOR計算がcoatedconductorのメタルベース層にも適用されており、単純な鏡面色ではなく正確な色付きの鏡面ハイライトを生み出しています。</translation>
    </message>
    <message>
        ...
        <translation>DiffuseTransmission(薄い葉やランプシェードのように、光が拡散的に反射も透過もするモデル)を使用しています。反射率と透過率がそれぞれ、単色ではなく実際のテクスチャに紐づけられており、両方のバックエンドで動作します。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのMaterial「hair」です。これは実際の映画制作用レンダラーでも使われている、物理ベースのMarschner/Chiangファイバー散乱モデルによるhair BSDFです。ここでは単純な球体に適用することで、このプロジェクト独自のHair Fibersデモとの、条件を揃えた並列比較を可能にしています。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのチェッカーボードテクスチャで、2色それぞれが単純な固定色ではなく、実際の画像(checker/mixテクスチャの内側に1階層ネストされたimagemapテクスチャ)に紐づけられています。テクスチャ参照が単独で存在するだけでなく、合成・入れ子にできることをテストします。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのNamedMaterialが、「mix」マテリアルの構成要素としてだけでなく、形状に直接参照されています(一度宣言し、名前で再利用する形)。加えて、そのマテリアルのパラメータの1つにテクスチャが紐づけられており、さらにtwosidedフラグが設定されたAreaLightSourceにより両面が発光します。</translation>
    </message>
    <message>
        ...
        <translation>7つの球体を、名前付きガラスIORプリセット(BK7、BAF10、FK51A、LASF9、F5、F10、F11)ごとに1つずつ用意したシーンです。各プリセットはFindGlassPreset()によって、レンダリングの基準波長における固定のdielectric IOR値に解決されます。これは実在の光学ガラスカタログで使われているのと同じ参照テーブルであり、以前はユニットテストからのみ到達可能で、このシーンが登場するまで実際にレンダリングされたことはありませんでした。</translation>
    </message>
    <message>
        ...
        <translation>同じソース画像と同じUVスケールを持つ4枚のクアッドで、それぞれimagemapテクスチャの1つのオプションだけを切り分けています。基準となるデフォルトのsRGBデコード+wrap-repeat、同じバイト列をより明るく読み取るlinearデコード(通常は中間調を圧縮するガンマカーブを飛ばす)のクアッド、[0,1]を超えてタイリングする代わりに端のテクセルを保持するclamp-wrapのクアッド、そしてチャンネルを反転させたクアッドです。これらの経路はいずれも、他のどの同梱シーンのデフォルトのテクスチャ設定でも到達できないものでした。</translation>
    </message>
    <message>
        ...
        <translation>左から右へ並んだ4枚のクアッドは、それぞれビルダーには組み込み済みでありながら、これまでどの同梱シーンでも使われたことのなかった異なるpbrt-v4プロシージャルテクスチャクラスによって駆動されています。windy(パラメータのない乱流)、wrinkled(オクターブと粗さを調整可能なPerlin乱流)、dots(Perlinノイズの境界で分かれた2つの単色)、bilerp(UV全体になめらかにブレンドされる4隅の色)です。</translation>
    </message>
    <message>
        ...
        <translation>2枚のクアッドで、2階層の入れ子になったテクスチャ(外側のチェッカーボードのtex1がさらに別のチェッカーボードで、そのtex1が実際の画像である)を、並べて再現したより単純な1階層のケースと比較しています。CPUでは本物の入れ子で、同じ写真の異なる2つのチェッカー周波数が実際に互いの内側でタイリングされます。GPUは意図的に入れ子構造全体を1つの平均色に平坦化し、代わりに警告を出します - これはバグではなく文書化された近似であるため、両方の方式でこのシーンをレンダリングすると、実際の違いが明らかになります。</translation>
    </message>
    <message>
        ...
        <translation>局所的な発光体ではなく、プロシージャルなHDR空のグラデーション(青い天頂から暖色の地平線へのフェード)が画像ベースの無限光として組み込まれ、それのみで照らされる開放的なシーンです。拡散反射の球体、ほぼ鏡面のメタル球体、dielectricの球体が下に置かれ、この環境照明がソフトなアンビエントオクルージョン風のシェーディングから、空のグラデーションが鋭く反射・屈折して映り込む様子まで、異なるBSDFでどう見えるかを示しています。</translation>
    </message>
    <message>
        ...
        <translation>何もないコーネル壁が、天井から真下に向けられた単一のスポットライト風の点光源のみによって照らされています。全体のコーン幅は広く、内側の減衰開始角はより狭く設定されているため、輪郭のはっきりした光の円盤ではなく、滑らかな半影が生まれます。エリアライトを使うコーネルシーンとは異なり、これはサンプリングすべき面を持たないデルタライトです。コーン形状と減衰の仕方こそがこのシーンの要点です。</translation>
    </message>
    <message>
        ...
        <translation>何もないコーネル壁が、太陽光のような平行光線であるdistant lightによって照らされています。これは固定された方向ベクトルを持ち、1/r^2の減衰がないため、放射輝度のスケールは距離を補正した強度ではなく、直接入射照度そのものになります。減衰するpoint/spot/gonioライトと並んで、指向性を持ち減衰しないライトも正しく扱えるかを検証するための、意図的な対比シーンです。</translation>
    </message>
    <message>
        ...
        <translation>コーネル壁が、頭上に置かれた単一の等方性point lightによって照らされています。古典的な1/r^2の強度減衰を持つ、このカテゴリの中で最も単純な点光源です。コーンもなく、方向依存のプロファイルもなく、平行光線でもなく、天井付近の1点から距離のみに基づいて減衰するだけの光です。</translation>
    </message>
    <message>
        ...
        <translation>コーネル壁が、goniometricライトによって照らされています。これは一様に発光するのではなく、テーブル化された画像に従って方向ごとに強度が変化する点光源で、通常のpoint lightと同じ1/r^2の減衰と、プロファイルをワールド空間で向けるための明示的な回転を組み合わせています。スポットライトの単純なコーンやpoint lightの一様な発光とは対照的な、任意方向強度のケースです。</translation>
    </message>
    <message>
        ...
        <translation>コーネル壁が、projectionライトによって照らされています。これは単純なコーンや一様な球状の光を放つのではなく、透視錐台を通してチェッカーボードのスライド画像を投影する点光源で、実物のスライドプロジェクターのようにシーンにくっきりしたパターンのビームを投げかけます。</translation>
    </message>
    <message>
        ...
        <translation>天井のライトクアッドを一切持たないコーネル風の部屋です。代わりに背面の壁に実際に長方形の穴が開けられており、その窓を通してのみ空の光が見えます。これはポータルサンプリングされた無限光をテストするもので、環境光のサンプリングは全球方向ではなく、実際にポータル開口部を通して見える方向のみに限定されます。無限光のNext Event Estimation(NEE)にとって、より難しく破綻しやすいケースです。</translation>
    </message>
    <message>
        ...
        <translation>pbrt-v4の点(デルタ分布)光源5種類すべて、point、spot、distant、goniometric、projectionを1つのシーンにまとめています。面積ゼロの光源タイプをすべて並べて比較できる、単一のリファレンスシーンです。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのgoniometricライトおよびprojectionライトの、実際の画像デコード機能をテストするシーンです。以前はfilenameパラメータが警告なく無視され、一様なビームにフォールバックしてしまっていました。このシーンは、これらのライトが現在では実際に画像を読み込んで適用していることを確認する回帰テストです。</translation>
    </message>
    <message>
        ...
        <translation>pbrtの「blackbody L」ライトカラーで、RGBの三つ組ではなくケルビン単位の色温度で指定され、実際のプランク軌跡に基づく黒体放射からRGBへの変換計算を通して求められます。それ以外は同一の2枚のパネルが、白熱灯のような暖色の色温度と、曇り空のような寒色の色温度でそれぞれ並べて置かれているため、色変換に不具合があれば両パネルが単なる白になってしまい、すぐに気づけるようになっています。</translation>
    </message>
    <message>
        ...
        <translation>三角形以外の形状(球体やクアッド)に設定されたAreaLightSourceで、filenameによってテクスチャ化されている(発光パターンが単色ではなく画像から来る)と同時に、twosidedでもある(表面法線が向く側だけでなく両面から発光する)ものを、両方のバックエンドでテストします。</translation>
    </message>
    <message>
        ...
        <translation>pbrtの「infinite」ライトです。形状を一切持たない単色のライトで、あらゆる方向から一度にシーンを照らします。空の代わりとして考えられる中で最も単純なものです。閉じた部屋ではどの方向からも遮られてしまうため、この効果を見るには開放的な形状が必要です。</translation>
    </message>
    <message>
        ...
        <translation>diskとcylinderの形状が、本物のNext Event Estimation(NEE)光源として機能します。バウンスのたびに偶然当たるのを待つのではなく、ライトに向けた立体角サンプリングを行います。両方のGPUバックエンドで、NEEに対応しないライトが受けるノイズの多い「レイが偶然当たることを期待する」フォールバックよりも、CPU側と同じくらいきれいに収束します。</translation>
    </message>
    <message>
        ...
        <translation>1つのシーンに2つの独立した球体エリアライトを配置した、最小限のケースです。かつて実在したGPU側のバグを特定したシーンで、ライトタイプの参照テーブルが1つのライト分のサイズしか確保されていなかったため、2つ目以降のライトはすべて自身のタイプを警告なく誤って読み取り、誤ってレンダリングされていました。</translation>
    </message>
    <message>
        ...
        <translation>不規則な5三角形のファン形状をしたエリアライトです。単純な平行四辺形ではなく、レンダラーのクアッド結合最適化(2つの三角形を1つのクアッドに再結合し、より安価にサンプリングする仕組み)でも結合できない形状です。そのため、より一般的なクアッド用のショートカットではなく、GPU上での本物の三角形単位のライトサンプリングをテストします。</translation>
    </message>
    <message>
        ...
        <translation>pbrtの「ColorSpace」ディレクティブは、「blackbody」の色温度がどの作業用RGB色空間(ここではデフォルトのsRGBではなく、より広い原色を持つRec.2020)を通して変換されるかを選択します。ジオメトリと2500K/9000Kの色温度はBlackbody Lightの例とまったく同一で、宣言された色空間のみが異なります - そのため両シーンのパネルの色を直接見比べることで、このディレクティブが単に解析されて無視されているのではなく、実際に適用されていることを直接証明できます。</translation>
    </message>
    <message>
        ...
        <translation>本物のpbrt-v4 PortalImageInfiniteLightです。等面積の環境マップ無限光を、ウィンドウ(開口部)のクアッドに制限したもので、あらゆる方向から環境全体が漏れ込むのではなく、その開口部だけが実際の空のディテールを映し出します。ネイティブの「Portal Infinite Light」シーン(C7)は、平坦なsky_lightの背後の壁に幾何学的な穴を開けるだけで、このクラス自体は実際には構築していません - このシーンが、実際にこのクラスを構築する最初の同梱シーンです。</translation>
    </message>
    <message>
        ...
        <translation>それ以外は同一な3つの球体を、それぞれpoint、spot、areaの1種類のライトだけで照らしたシーンです。明るさは通常のintensity/radianceを直接指定するのではなく、「float power」(ワット単位の総光束)として指定されています。レンダラーは、ライトの種類ごとに異なる立体角の公式(点光源では4π、スポットライトでは円錐の立体角、ランバート発光体では面積×πなど)を通してpowerからintensityへの変換を逆算する必要があります。そのため、いずれか1種類の変換が誤っていれば、シーン全体が一様に間違うのではなく、その球体の明るさだけが目に見えて食い違うという形で現れます。</translation>
    </message>
    <message>
        ...
        <translation>projectionライトのスライド画像として、他のすべてのprojectionライトシーンが使う通常の正方形のuv-checker.bmpではなく、意図的に非正方形(8x4)の画像を使用しています。画像とライト自身の視野角との間で実際のアスペクト比の不一致が生じる、最初の同梱シーンです。アスペクト比を正しく保った投影であれば、画像自身の2:1の形状に一致する、はっきりと横長の長方形の投影範囲が映し出されます。ここにバグがあれば、投影範囲が正方形に押しつぶされたり、ライトのfovいっぱいに引き伸ばされたりしてしまいます。</translation>
    </message>
    <message>
        ...
        <translation>単純な拡散反射面の上に、彩度の高い近距離の色付きライトを3つ配置したシーンです。--spectralレンダリング下で、それらの重なり合う領域がちょうどsRGBの色域境界に位置するように配置されています。これはまさに、サンプルごとのXYZからRGBへの色域クランプに実在したバグが、誤って暗く・彩度を落としてしまっていた条件です。修正では、この変換をサンプルごとではなくピクセルごとに遅延させるようにしたため、重なり合う領域はここでは白/パステル調へなめらかにブレンドされるはずで、バンディングや彩度不足のくすんだパッチにはならないはずです。</translation>
    </message>
    <message>
        ...
        <translation>チェッカーの地面と、複数の奥行きに配置された球体(ガラス1つ、メタル1つ)からなる開放的なシーンを、デフォルトの透視投影カメラに内蔵された薄レンズによるデフォーカスブラーでレンダリングしています。ピント距離にある球体のみがシャープにレンダリングされ、手前と奥の球体はぼやけます。別のカメラクラスを使わない、単純な絞り+ピント距離による被写界深度の経路です。</translation>
    </message>
    <message>
        ...
        <translation>チェッカーの地面の上に並んだ球体の列を、明示的な正投影(orthographic)カメラでレンダリングしています。レイは1つの視点から収束するのではなく平行に発射されるため、球体には遠近感による見かけの縮小が生じません。同じ大きさの球体は奥行きに関係なく同じ大きさに見えます。これは平行投影の見た目上の決定的な特徴です。</translation>
    </message>
    <message>
        ...
        <translation>中央の発光球体を取り囲むように配置された色付きの球体の輪を、明示的な球面(正距円筒図法)カメラで撮影しています。限られた視野角の錐台ではなく、360度全方位の周囲が1枚のパノラマ画像にマッピングされます。</translation>
    </message>
    <message>
        ...
        <translation>チェッカーの地面の上に、奥行きを変えて配置された5つの球体を、理想化された薄レンズの代わりに実際の多素子レンズ処方(面ごとの曲率、厚み、IOR、絞り)から構築された明示的なrealisticカメラでレンダリングしています。レイはレンズスタックを1素子ずつ順にたどって追跡され、閉形式のデフォーカス円近似ではなく、本物のレンズに起因するボケとビネットを生み出します。</translation>
    </message>
    <message>
        ...
        <translation>通常のコーネルボックスシーンや他のカメラ比較用コーネルシーンと同じ古典的なコーネルボックス形状を、別のカメラクラスではなくデフォルトの透視投影カメラの薄レンズによるデフォーカスブラーでレンダリングしています。他のカメラ比較シーンと同じ部屋を使うことで被写界深度のみを変数として切り分けており、異なる形状による混乱を招くことなく、この技法の効果を直接比較できるようにしています。</translation>
    </message>
    <message>
        ...
        <translation>他のカメラ比較シーンと同じ共有のコーネルボックスを、明示的な正投影(orthographic)カメラで、ボックスの奥行き軸に沿って真正面から見た構図でレンダリングしています。投影が透視ではなく平行投影であるため、透視/被写界深度版のように収束するのではなく、ボックスの辺はフレームの端まで平行なままです。この対比をわかりやすくするために、あえて同じ部屋が使われています。</translation>
    </message>
    <message>
        ...
        <translation>同じ共有のコーネルボックスを、ボックスの中心に配置した明示的な球面(正距円筒図法)カメラで巡っています。パノラマは、単一の内部視点から、5枚の壁すべて、天井のライト、ガラス球体を1枚の360度画像にラップします。単独のSpherical Cameraシーンと同じ技法を、共有の比較用形状に適用したものです。</translation>
    </message>
    <message>
        ...
        <translation>同じ共有のコーネルボックスを、単独のRealistic Cameraシーンで使われているのと同一の多素子realisticカメラのレンズ処方でレンダリングしていますが、ボックスのはるかに大きなスケールに合わせて絞りを拡大しています。これにより、シーンのスケールが異なっていても、デフォーカスコーンの角度的な大きさ、ひいては見た目のレンズボケが比較可能な状態に保たれています。</translation>
    </message>
    <message>
        ...
        <translation>共有される同じCornell Boxですが、露光中にカメラ自体が動きます - 実際のAnimatedTransform補間(pbrt-v4のモーションブラー技術)によって片側からもう片側へキーフレームが設定され、単一の固定カメラ位置ではなく、各レイがシャッター区間内の独自の時刻をサンプリングします。デフォルトのパストレーサーとSPPMでのみ適用されます(BDPT/MLT/デバッグ用インテグレータでは、代わりに最初のキーフレームの静止画がレンダリングされます)。GPUも同様に最初のキーフレームの静止画をレンダリングします。</translation>
    </message>
    <message>
        ...
        <translation>透視投影カメラの薄レンズによる被写界深度(レンズ半径とピント距離)を、pbrtファイルのCameraディレクティブから直接読み込んでいます。両方のバックエンドで動作します。このプロジェクト独自のDepth of Fieldシーンと同じ光学モデルですが、こちらはファイル読み込みの経路をテストするものです。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのorthographic(平行投影)カメラをファイルから読み込んだシーンです。レイは1つの視点に収束するのではなくすべて平行になるため、異なる奥行きにある同じ大きさの2つの球体は、手前の方が大きく見えるのではなく、画面上で同じ大きさに見えます。これは通常の透視投影による遠近縮小とは逆の効果です。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのspherical(等面積)カメラをファイルから読み込んだシーンです。レイは平坦な画像平面を通過するのではなく、単一の点からあらゆる方向に扇状に広がるため、1回のレンダリングで360度全方位の周囲を捉えることができます。どの方向にも実際に何かが見えるよう、閉じた部屋の中に配置されています。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのrealisticカメラです。他のすべてのカメラシーンが使用する理想化された薄レンズ/ピンホールモデルではなく、実際の多素子レンズシステムをレンズ処方ファイルから読み込んでいます。レイは実際のガラス素子を通して1つずつ追跡され、本物の被写界深度とレンズ収差を生み出します。これには、組み込みシーンでは決してテストされることのなかったレンズファイル読み込みの経路も含まれます。</translation>
    </message>
    <message>
        ...
        <translation>コーネルボックスの内部を均質な参加媒質で満たしています。境界ボックスは一様な散乱係数とHenyey-Greenstein位相関数を持ちます。境界内のすべての点で密度が同一であるため、空間的に変化する密度モデルではなく、基本的な自由行程サンプリング/単一散乱係数によるメディウム経路をテストします。</translation>
    </message>
    <message>
        ...
        <translation>焼き込まれたボクセルデータの参照ではなく、点ごとに密度が手続き的に評価される、本物の不均質ボリュームです。マルチオクターブのPerlinノイズに、もやもやとした揺らぎの摂動と高度による減衰を組み合わせて評価されます。レンダリングには、不均一な密度場を扱うためにdelta tracking(ヌルコリジョンサンプリング)を用いており、実際の雲のように底部が濃く、上部が薄くなる様子を再現しています。</translation>
    </message>
    <message>
        ...
        <translation>dielectricと内部メディウムの組み合わせ自体を主題としたシーンです。それぞれ屈折するdielectric表面で作られたガラス球体の内部に、異なる密度の均質な参加媒質が詰め込まれています。散乱メディウムが不透明な殻ではなく、実際に屈折する表面に境界づけられているケースをテストします。レイは内部に屈折して入り、内部の霧を散乱・吸収しながら通過し、再び屈折して外へ出る必要があります。</translation>
    </message>
    <message>
        ...
        <translation>本物のボクセル単位の散乱データが3Dグリッドに焼き込まれた不均質メディウムです。赤・緑・青の各チャンネルが独立して異なる周波数で生成されているため、一様に色付いた雲のようには見えず、色が空間的に分離して見えます。majorantグリッドによって高速化されたdelta trackingを用いてサンプリングされます。点ごとに解析的に評価されるプロシージャルメディウムとは異なり、これはレンダー空間のボックスからグリッド自身の座標空間へマッピングされた離散的なボクセルデータです。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのMakeNamedMedium「cloud」です。3D Perlinノイズによって密度が決まる不均質な散乱ボリュームで、平坦で明らかに偽物とわかる霧の塊を避けるために、実際の雲のレンダリングでも使われるのと同じノイズ駆動の手法です。ファイルから読み込まれ、両方のバックエンドで動作します。</translation>
    </message>
    <message>
        ...
        <translation>cylinder形状に付与された均質な参加媒質(一様な霧/散乱密度)です。この組み合わせは以前、GPUバックエンドでは霧の効果が一切なく、警告なく単なる空の形状としてレンダリングされてしまっていました。このシーンは、GPU側でもこのメディウムが実際に機能するようになったことを確認する回帰テストです。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのMakeNamedMedium「rgbgrid」です。単なる密度スカラーではなく、各セルが独自のRGB散乱色を持つ3Dボクセルグリッドで、柔らかい色付きの星雲のようなボリュームとしてレンダリングされます。両方のバックエンドで動作します。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのMakeNamedMedium「uniformgrid」です。RGBグリッドメディウムのシーンとは異なり、ボクセルごとの色を持たない単一チャンネルの密度ボクセルグリッドで、柔らかく光る塊としてレンダリングされます。あちらのシーンよりも単純な、対になるシーンです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>bilinear patchプリミティブをテストするシーンです。これは三角形のペアではなく、独自の交差判定ルーチンで定義された真の4隅の曲面です。角の高さをオフセットした2枚のパッチを配置することで、双曲放物面のような鞍型の面と、湾曲したスロープを形成しています。シェーディングの階調が面の連続的な曲率をたどるように、意図的にやや粗めのメタルマテリアルが使われています。鏡面仕上げだと単一の鋭いハイライトしか見えず、面が平坦でないことがわかりにくくなってしまいます。</translation>
    </message>
    <message>
        ...
        <translation>プロシージャルな正二十面体を、本物のインデックス付き三角形メッシュとして構築しています。これは、レンダラーに読み込まれるすべてのメッシュが使用する、水密なレイ-三角形交差判定の経路をテストします。頂点ごとの法線は与えられていないため、各三角形は面ごとの平坦なジオメトリック法線にフォールバックし、スムーズシェーディングされた補間法線ではなく、面取りされたローポリ調の見た目になります。</translation>
    </message>
    <message>
        ...
        <translation>独自のレイ-カーブ交差判定を持つ、本物のカーブ形状をテストするシーンです。表面自体を曲げるのではなく単純な球体にhair BSDFを適用する別のHair Fibersシーンとは異なります。根元から先端にかけて先細るベジエストランドが表面全体に散らばって植え付けられており、hairシェーディングモデルではなく、カーブプリミティブ自体のスイープリボン形状をテストします。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのShape「plymesh」の、本物の頂点ごとのUVデータを、両方のバックエンドに通したシーンです。以前は、これらのUVが警告なく破棄されていたため、GPU再帰型ではこのシーンがまさに真っ黒にレンダリングされていました。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのShape「plymesh」が、実際の外部.plyメッシュファイルを最初から最後まで読み込むシーンです。ソースファイル中の三角形ではない面をファン三角形分割することも含まれています。ローダーは、すべての面が事前に三角形分割されているとは仮定できません。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのShape「curve」です。三角形メッシュによる近似ではなく、内部でGPU向きの三角形にテッセレーションされる本物の3次ベジエファイバー形状です。同じ方式で構築された、このプロジェクト独自のcurve-tuftデモと直接比較できるようになっています。</translation>
    </message>
    <message>
        ...
        <translation>本物のカーブ形状とMaterial「hair」を組み合わせた、このプロジェクトで初めてのシーンです。まさにこの組み合わせによって、hair BSDFがファイバー自身の接線方向ではなく平坦な面の法線を使ってしまっているバグが明らかになりました。各ストランドに沿ったハイライトを、単なるマットなふわつきではなく1本の毛のように見せているのは、この接線方向です。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのShape「trianglemesh」の「point2 uv」パラメータ、すなわち三角形メッシュ上の明示的な頂点ごとのテクスチャ座標を、両方のバックエンドに通したシーンです。この配線が存在する前は、GPU再帰型ではこのシーンがまさに真っ黒にレンダリングされていました。</translation>
    </message>
    <message>
        ...
        <translation>pbrtのPixelFilterディレクティブでbox filterを選択したシーンです。よりなめらかなデフォルトのガウシアンフィルタの代わりに、ピクセル境界で急に打ち切られる形で、ピクセル内のすべてのサンプルを等しく数えます。このシーンのよりエイリアシングの目立つ、輪郭の硬いシルエットを、他のデフォルトフィルタでレンダリングされたシーンと比較してみてください。</translation>
    </message>
    <message>
        ...
        <translation>球体のActiveTransformによるStartTime/EndTimeの区間指定により、同一の形状に2つの異なるワールド空間上の中心が焼き込まれ、カメラ自身のシャッター区間に応じてレイごとにサンプリングされます。動く球体は、くっきりとした像や二重像としてではなく、柔らかい方向性のあるストリークとしてレンダリングされるはずで、その隣には区間指定を一切行わない静的な参照用の球体が置かれています。下記のdisk/cylinderのケースとは異なり、CPU、GPU再帰型、GPU wavefront型の3つすべてのバックエンドで本物として動作します。</translation>
    </message>
    <message>
        ...
        <translation>Object Motion Blurシーンと同じActiveTransformによるモーションブラー技法を、球体ではなくShape「disk」/「cylinder」に適用したものです。内部的には異なるコード経路をたどります(球体のcenter1/center2の組ではなく、形状自身の開始/終了トランスフォームに焼き込まれます)。CPUのみで動作します。GPUが対応している球体のモーションブラーとは異なり、両方のGPUバックエンドは、これらの形状を開始姿勢のまま静止させてレンダリングし、ブラーの代わりに警告を出します。</translation>
    </message>
    <message>
        ...
        <translation>2枚のクアッドは同一の点配列と同一のインデックスの巻き方向を共有しており、それ自体ではカメラとは逆を向く法線が生成されます - この巻き方向のままの片面発光エリアライトは、正面からは見えません。2枚目のクアッドの直前に発行された単独のReverseOrientationディレクティブにより、実効的な法線がカメラの方を向くように反転され、その結果、一方のクアッドは暗いまま、もう一方は光ります。ReverseOrientationにバグがあれば、両方のクアッドが暗いか、両方とも光ってしまうはずで、片方だけが光るという状態には決してなりません。</translation>
    </message>
    <message>
        ...
        <translation>このプロジェクト独自のpbrt-v3互換拡張(本物のpbrt-v4には含まれないShape「cone」/「paraboloid」)をテストする4つの形状です。基本形状としての単純な拡散反射のconeとparaboloid、通常のマテリアルの代わりにAreaLightSourceの発光体として使われるcone、そしてMediumInterfaceの霧の境界として使われるparaboloidで、開いた縁がカメラを向いているため、レイは固体表面ではなく開口端からメディウムに入ります。CPUのみで動作します - GPU(両方のバックエンド)はcone/paraboloid形状を検出すると警告を出し、完全に取り除きます。</translation>
    </message>
    <message>
        ...
        <translation>pbrt-v4の定番サンプルシーンである「killeroo」像です。このレンダラーに直接組み込まれたものではなく、独自の.pbrtファイル(形状、マテリアル、ライト、カメラすべてがファイル駆動)から読み込まれる、最初から最後まで完結したシーンです。ユーザー自身のカスタムpbrtシーンが通るのと同じファイル形式・読み込み経路を使用します。</translation>
    </message>
    <message>
        ...
        <translation>A1と全く同じCornell Boxですが、通常の100サンプルではなく、あえてピクセルあたり16サンプルという低い値でレンダリングしています - きれいに収束するには少なすぎる数です。レンダリングオプションタブでサンプラー(Sobol、Z-Sobol、Padded Sobol、Stratified、PMJ02BN、Halton)を切り替えて再レンダリングしてみてください。それぞれの選択は、ピクセルと光源にこの16サンプルを分布させるための異なる低差異序列であり、シーンの他の要素は何も変わらなくても、ソフトシャドウの半影部分におけるノイズ/かたまりのパターンがそれに応じて変化します。CPUのデフォルトパストレーサーにのみ適用され、サンプラーコントロールはGPUには影響しません。</translation>
    </message>
    <message>
        ...
        <translation>B23(スペクトル分散)と同じガラスプリズムを、ここでは「スペクトルレンダリング」チェックボックス自体のデモとして再構成したものです。スペクトルレンダリング(レンダリングオプションタブ)をオフにすると、レンダラーは赤/緑/青の3チャンネルのみを追跡し、すべての波長がガラス中で同じ固定量だけ屈折します。オンにすると、レンダラーはレイごとの実際の波長を追跡し、プリズムの屈折率が波長によって本当に変化するようになり、物理的なプリズムと同じように白色光を可視スペクトルへと分散させます。CPUのデフォルトパストレーサーにのみ適用されます。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>B3(Cornell Rough Glass)と同じすりガラスのコーネルボックスを、インテグレータのドロップダウン自体のSPPMデモとして再構成したものです。同じサンプル数で、デフォルトのパストレーサーで1回、SPPM(レンダリングオプションタブ)で1回レンダリングしてみてください。rough_dielectricの球体の下にできる床のコースティクス - 通常のパストレーシングが収束に苦労する、まさに難しく高周波な間接光のケース - が、まさにこの種の光の伝播のために作られたSPPMのフォトンマッピング方式では、目に見えて速くきれいになるはずです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>このデモ専用に構築されたコーネルボックスです。A1の1つの代わりに天井に5つのライトがあり、意図的に不均衡なパワー(サイズが違うだけでなく、おおよそ1:2:6:15:80の比率)を持たせています。Uniform(ライトサンプラー、レンダリングオプションタブ)は、各ライトが実際に画像へどれだけ寄与しているかに関係なく、すべてのnext-event-estimationサンプルの5分の1を各ライトに費やします - そのため、ほとんどのサンプルはほとんど重要でない4つのライトに向けられ、本当に支配的な1つのライトは必要以上にノイズが残ります。PowerとBVHはどちらもその支配的なライトへ選択を重み付けします(BVHは距離/方向も考慮し、Powerは放出される総光束のみを考慮します) - 同じ低いサンプル数で3つすべてをレンダリングし、明るい角のライト周辺のノイズがどれだけ速く収まるか比較してください。</translation>
    </message>
    <message>
        ...
        <translation>A1と同じコーネルボックスを、インテグレータのドロップダウン自体のAmbient Occlusionデモとして再構成したものです。AOは意図的にまったく照明されたレンダリングではありません。それに切り替える(レンダリングオプションタブ)と、各サーフェス自身の色とシーン内のすべての実際のライトが完全に無視され、単一のグレースケールのオクルージョン項に置き換えられます - 各点の上の半球のうちどれだけが近くのジオメトリによって遮られているか、というものです。回転したボックス自身のコンタクトシャドウと、2つの壁が接する角だけが残る構造であり、これこそがAOをシーンの照明から切り離した幾何学的複雑さの高速プレビューとして役立たせている理由です。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../mainwindow_widgets.h" line="956"/>
        <source>No renders yet</source>
        <translation>レンダリング結果はまだありません</translation>
    </message>
    <message>
        <location filename="../mainwindow_widgets.h" line="964"/>
