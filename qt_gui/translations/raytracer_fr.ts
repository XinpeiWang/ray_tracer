...
Generate Video cannot be combined with an alternate Integrator - see the warning below if that combination is picked.</source>
        <translation>Détermine si ce rendu produit une seule image fixe, ou une séquence d&apos;images assemblées en vidéo.
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Basic Settings tab to use it.</source>
        <translation>Le tracé de rayons a besoin de beaucoup de nombres aléatoires - dans quelle direction faire rebondir un rayon, quel point d&apos;une lumière échantillonner, etc. - et la façon dont ces nombres « aléatoires » sont générés change la vitesse à laquelle l&apos;image converge vers un résultat propre.
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Basic Settings tab to use it.</source>
        <translation>Chaque rebond diffus/glossy doit choisir UNE lumière (parmi potentiellement beaucoup d&apos;autres) à échantillonner directement pour l&apos;estimation par événement suivant - la lumière choisie, et l&apos;équité de ce choix, change la vitesse à laquelle l&apos;image converge, mais jamais vers QUOI elle converge.
