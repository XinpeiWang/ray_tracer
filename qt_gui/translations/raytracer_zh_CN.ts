...
（如果已有渲染正在进行，则改为加入队列排在其后）</translation>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;Ray Tracer&lt;/h3&gt;&lt;p&gt;一款基于物理的路径追踪器，拥有并行的 CPU 与 GPU(OptiX)后端，从 &lt;i&gt;Ray Tracing in One Weekend&lt;/i&gt; 系列逐步扩展为具备 pbrt-v4 风格特性集的完整渲染器。&lt;/p&gt;&lt;p&gt;123 个场景、丰富的 BxDF 材质库、多种光源与相机类型、三角网格与纹理支持、BVH 加速结构、体积渲染效果，以及在标准路径追踪之外可选的多种积分器——SPPM 光子映射、双向路径追踪(BDPT)、Metropolis 光传输(MLT)，以及若干参考/调试用积分器(RandomWalk、Ambient Occlusion、SimplePath、SimpleVolPath、LightPath)。&lt;/p&gt;&lt;p&gt;本窗口以子进程方式驱动 &lt;code&gt;%1&lt;/code&gt;。&lt;/p&gt;</translation>
    </message>
    <message>
