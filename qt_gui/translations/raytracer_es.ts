...
BDPT/MLT/SPPM/the debug integrators.</source>
        <translation>Qué muestreador de baja discrepancia impulsa las decisiones aleatorias.
...
Grayed out? This only affects the CPU renderer&apos;s default path tracer - switch Renderer to CPU on the Basic Settings tab to use it.</source>
        <translation>El trazado de rayos necesita muchos números aleatorios - en qué dirección rebotar un rayo, qué punto de una luz muestrear, etc. - y CÓMO se generan esos números &quot;aleatorios&quot; cambia la rapidez con la que la imagen converge a un resultado limpio.
